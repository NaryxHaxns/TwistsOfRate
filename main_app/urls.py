...
urlpatterns = [
    ...
    path('consoles/<int:console_id>/edit_console_comment/<int:comment_id>/', views.edit_console_comment, name='edit_console_comment'),
    path('consoles/<int:console_id>/delete_console_comment/<int:comment_id>/', views.delete_console_comment, name='delete_console_comment'),
